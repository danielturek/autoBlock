...
if(FALSE) {
    ...
    save(code_ice, constants_ice, data_ice, inits_ice, file = 'ice.RData')
...
if(FALSE) {
    ...
    Rmodel <- nimbleModel(code=code_ice, constants=constants_ice, data=data_ice, inits=inits_ice)
    
    spec <- configureMCMC(Rmodel)
    spec$getSamplers()
    spec$addMonitors(c('logRR'))
