...
load('~/GitHub/autoBlock/modelfiles/mhp.RData')
N <- dim(mhp)[1]
...
df <- read.dta('~/GitHub/autoBlock/modelfiles/2000_labeled_processed_race.dta')
...
Nstates <- max(state)
## state level data
st <- read.table('~/GitHub/autoBlock/modelfiles/st.dat')
